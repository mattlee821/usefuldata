---
title: "SomaLogic Mapping"
output: 
  rmarkdown::html_vignette:
    toc: false
vignette: >
  %\VignetteIndexEntry{SomaLogic Mapping}
...
1.  **Input Data**: Raw data was retrieved from the SomaLogic GitHub repository (Example Data v5.0 Plasma ADAT).
2.  **Formatting**:
...
3.  **Mapping**: UniProt IDs, Entrez IDs, and HGNC symbols were mapped to Ensembl Gene IDs using `biomaRt` (Ensembl dataset `hsapiens_gene_ensembl`).
4.  **Filtering**:
